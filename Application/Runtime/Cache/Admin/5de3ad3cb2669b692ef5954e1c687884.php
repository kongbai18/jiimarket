...
<div class="main-div">
    <form method="post" action="/index.php/Admin/Attribute/edit/id/1.html"enctype="multipart/form-data" >
        ...
        <input type="hidden" name="id" value="<?php echo $data['id'] ?>">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="attr_option_values" maxlength="60" value="<?php echo $data['attr_option_values'] ?>" />
                </td>
            </tr>
            <tr>
